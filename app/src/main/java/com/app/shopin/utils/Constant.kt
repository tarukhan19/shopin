...
class Constant {
        ...
        companion object
        {
            ...
            const val KEY_FROM_EMAILID_OR_MOBNO="KEY_FROM_EMAILID_OR_MOBNO"
            const val KEY_TOKEN ="KEY_TOKEN"
            const val KEY_EMAIL_ID="KEY_EMAILID"
            const val KEY_MOBILE_NO="KEY_MOBILE_NO"
            const val KEY_USER_ID="KEY_USER_ID"
            const val KEY_NAME="KEY_NAME"
            const val KEY_USER_PIC="KEY_USER_PIC"
            const val LOCATION_PERMISSIONS_REQUEST: Int = 101
            const val PERMISSIONS_REQUEST: Int = 102
            const val REQUEST_CHECK_SETTINGS: Int = 103
            const val callPermissionRequest: Int = 104
