...
class AddToCartViewModel : ViewModel() {
    ...
    fun addToCartResponse(requireContext: Context, price: String, quantity: String, is_update: String
        ...
        request.addToCart(price,quantity,is_update,inventory, tax_amount, total_amount, tax_percentage,store).enqueue(object :
