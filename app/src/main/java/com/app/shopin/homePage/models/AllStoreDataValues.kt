...
data class AllStoreDataValues(
    ...
    val store_inventory: ArrayList<StoreInventoryData>?,
    val cart_item: ArrayList<StoreInventoryData>?,
    val inventory_items: ArrayList<StoreInventoryData>?,
    val order_item: ArrayList<StoreInventoryData>?,
    val business_type: Boolean,
    val rating_details: StoreratingData,
    val store_delivery_pickup: StoreDeliveryPickupData
