...
class StoreDetailItemAdapter(
    ...
    override fun onCreateViewHolder(parent: ViewGroup, viewType: Int): MyViewHolder {
        ...
        binding =
            DataBindingUtil.inflate(LayoutInflater.from(ctx), R.layout.item_product, parent, false)
        addToCartViewModel =
            ViewModelProvider(ctx as FragmentActivity).get(AddToCartViewModel::class.java)
        removeCartViewModel =
            ViewModelProvider(ctx as FragmentActivity).get(RemoveCartViewModel::class.java)
...
//            catch (e:Exception){}
    ...
    private fun addToCart(
        ...
        addToCartViewModel.addToCartResponse(
            ctx,
            ordertype!!,
            storeInventoryData.price!!,
            quantity,
            is_update,
            storeInventoryData.id!!,
            "",
            totalamount,
            "",
            storeInventoryData.store!!
        )
    }
